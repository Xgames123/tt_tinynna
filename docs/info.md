...
`nna8v2` is a custom 8 bit processor that fits in 1 tile.
...
An overview of the instructions and the processor can be found [here](https://github.com/Xgames123/nna/blob/main/spec/nna8v2.md)
...
The logic is made using [digital](https://github.com/hneemann/digital).
